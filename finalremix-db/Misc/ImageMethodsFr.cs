...
{
    public static class ImageMethodsFr
    {
        ...
        public static bool HasJapaneseCounterpart(string SpriteFileName)
        {
            return Resources.ResourceManager.GetObject(SpriteFileName + "_J") != null;
        }
    }
}
